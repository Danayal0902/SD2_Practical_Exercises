...
namespace Classes2
{
	...
	class Class2
	{
		static void Main(string[] args)
		{
			...
			car1.Cost=15000;
			Console.WriteLine(
				"Car is a " + car1.Make + " " + car1.Type + " colour is " + car1.Colour + " built in " + car1.Country + " and costs £" + car1.Cost);

            Car2 car2 = new Car2();
            car2.Colour = "Deep blue";
            car2.Make = "Nissan";
            car2.Type = "GT-R R35";
            car2.Country = "UK";
            car2.Cost = 50000;
            Console.WriteLine(
                "Car is a " + car2.Make + " " + car2.Type + " colour is " + car2.Colour + " built in " + car2.Country + " and costs £" + car2.Cost);
